...
| ------------------------------------------------------ | -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [agents](agents/README.md)                             | `ghcr.io/devc-tools/features/agents`               | Installs coding-agent CLIs — Claude Code, and optionally Copilot, pi, Herdr and agent-browser — and keeps all of Claude Code's state in one place.                     |
