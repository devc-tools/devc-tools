...
| ------------------------------------------------------ | -------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [agents](agents/README.md)                             | `ghcr.io/devc-tools/features/agents`               | Installs coding-agent CLIs — Claude Code, and optionally Copilot, pi, Herdr and agent-browser — and keeps all of Claude Code's state in one declared volume, with an opt-in config seed. |
...
| [godot](godot/README.md)                               | `ghcr.io/devc-tools/features/godot`                | Installs the latest stable Godot engine at build time and declares a per-devcontainer volume for the project's `.godot/` cache directory.                                                |
